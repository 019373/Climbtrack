...
import { Download, Upload, Trash2, RotateCcw, ChevronDown, ChevronRight, Dumbbell } from "lucide-react";
...
export function ReglagesPage() {
  ...
  const [exerciseSectionOpen, setExerciseSectionOpen] = useState(false);
    ...
    <div className="min-h-screen bg-background pb-24 pt-safe">
      ...
      <main className="p-5 space-y-8">
        ...
        <section className="space-y-4">
          <button
            onClick={() => setExerciseSectionOpen(o => !o)}
          ...
          {exerciseSectionOpen && <ExerciseManager />}
        </section>
        ...
        <div className="text-center pt-8">
          ...
          <p className="text-xs text-muted-foreground mt-1">v1.1.0 • Local Storage Only</p>
        </div>
